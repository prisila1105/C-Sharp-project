...
namespace Doctors_Patients_portal
{
    class DataAccess
    {
        ...
        private static string strConnString = @"Data Source=DESKTOP-2Q8MQF2\SQLEXPRESS;Initial Catalog=doctor_patient;Integrated Security=True";
        ...
        {
            SqlConnection conn = new SqlConnection(@"Data Source=DESKTOP-2Q8MQF2\SQLEXPRESS;Initial Catalog=doctor_patient;Integrated Security=True");
            conn.Open();
